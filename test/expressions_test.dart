...
void main() {
  ...
  test('Action', () {
    ...
    expect($s.position, 0, reason: '\$ = `const` { 41 }\n\'a\'\nstate.position = 0\n');
    expect($r2.$1, 41, reason: '\$ = `const` { 41 }\n\'a\'\nresult.\$1 != 41\n');
    final $s1 = State('a');
    final $r3 = $r1($s1) as dynamic;
    expect($r3, isNotNull, reason: '\$ = `const` { 41 }\n\'a\'\nresult != null\n');
    expect($s1.position, 0, reason: '\$ = `const` { 41 }\n\'a\'\nstate.position = 0\n');
    expect($r3.$1, null, reason: '\$ = `const` { 41 }\n\'a\'\nresult.\$1 != null\n');
    final $s2 = State('');
    final $r4 = $r($s2) as dynamic;
    expect($r4, isNotNull, reason: '\$ = `const` { 41 }\n\'\'\nresult != null\n');
    expect($s2.position, 0, reason: '\$ = `const` { 41 }\n\'\'\nstate.position = 0\n');
    expect($r4.$1, 41, reason: '\$ = `const` { 41 }\n\'\'\nresult.\$1 != 41\n');
    final $s3 = State('');
    final $r5 = $r1($s3) as dynamic;
    expect($r5, isNotNull, reason: '\$ = `const` { 41 }\n\'\'\nresult != null\n');
    expect($s3.position, 0, reason: '\$ = `const` { 41 }\n\'\'\nstate.position = 0\n');
    expect($r5.$1, null, reason: '\$ = `const` { 41 }\n\'\'\nresult.\$1 != null\n');
    final $r6 = parser.parseAction1;
    final $r7 = parser.parseActionVoid1;
    final $s4 = State('a');
    final $r8 = $r6($s4) as dynamic;
    expect($r8, isNotNull, reason: '\$ = `const` { 41 }\n\'a\'\nresult != null\n');
    expect($s4.position, 0, reason: '\$ = `const` { 41 }\n\'a\'\nstate.position = 0\n');
    expect($r8.$1, 41, reason: '\$ = `const` { 41 }\n\'a\'\nresult.\$1 != 41\n');
    final $s5 = State('a');
    final $r9 = $r7($s5) as dynamic;
    expect($r9, isNotNull, reason: '\$ = `const` { 41 }\n\'a\'\nresult != null\n');
    expect($s5.position, 0, reason: '\$ = `const` { 41 }\n\'a\'\nstate.position = 0\n');
    expect($r9.$1, null, reason: '\$ = `const` { 41 }\n\'a\'\nresult.\$1 != null\n');
    final $s6 = State('');
    final $r10 = $r6($s6) as dynamic;
    expect($r10, isNotNull, reason: '\$ = `const` { 41 }\n\'\'\nresult != null\n');
    expect($s6.position, 0, reason: '\$ = `const` { 41 }\n\'\'\nstate.position = 0\n');
    expect($r10.$1, 41, reason: '\$ = `const` { 41 }\n\'\'\nresult.\$1 != 41\n');
    final $s7 = State('');
    final $r11 = $r7($s7) as dynamic;
    expect($r11, isNotNull, reason: '\$ = `const` { 41 }\n\'\'\nresult != null\n');
    expect($s7.position, 0, reason: '\$ = `const` { 41 }\n\'\'\nstate.position = 0\n');
    expect($r11.$1, null, reason: '\$ = `const` { 41 }\n\'\'\nresult.\$1 != null\n');
    final $r12 = parser.parseAction2;
    final $r13 = parser.parseActionVoid2;
    final $s8 = State('a');
    final $r14 = $r12($s8) as dynamic;
    expect($r14, isNotNull, reason: '\$ = `const int` { 41 }\n\'a\'\nresult != null\n');
    expect($s8.position, 0, reason: '\$ = `const int` { 41 }\n\'a\'\nstate.position = 0\n');
    expect($r14.$1, 41, reason: '\$ = `const int` { 41 }\n\'a\'\nresult.\$1 != 41\n');
    final $s9 = State('a');
    final $r15 = $r13($s9) as dynamic;
    expect($r15, isNotNull, reason: '\$ = `const int` { 41 }\n\'a\'\nresult != null\n');
    expect($s9.position, 0, reason: '\$ = `const int` { 41 }\n\'a\'\nstate.position = 0\n');
    expect($r15.$1, null, reason: '\$ = `const int` { 41 }\n\'a\'\nresult.\$1 != null\n');
    final $s10 = State('');
    final $r16 = $r12($s10) as dynamic;
    expect($r16, isNotNull, reason: '\$ = `const int` { 41 }\n\'\'\nresult != null\n');
    expect($s10.position, 0, reason: '\$ = `const int` { 41 }\n\'\'\nstate.position = 0\n');
    expect($r16.$1, 41, reason: '\$ = `const int` { 41 }\n\'\'\nresult.\$1 != 41\n');
    final $s11 = State('');
    final $r17 = $r13($s11) as dynamic;
    expect($r17, isNotNull, reason: '\$ = `const int` { 41 }\n\'\'\nresult != null\n');
    expect($s11.position, 0, reason: '\$ = `const int` { 41 }\n\'\'\nstate.position = 0\n');
    expect($r17.$1, null, reason: '\$ = `const int` { 41 }\n\'\'\nresult.\$1 != null\n');
    final $r18 = parser.parseAction3;
    final $r19 = parser.parseActionVoid3;
    final $s12 = State('a');
    final $r20 = $r18($s12) as dynamic;
    expect($r20, isNotNull, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'a\'\nresult != null\n');
    expect($s12.position, 0, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'a\'\nstate.position = 0\n');
    expect($r20.$1, 41, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'a\'\nresult.\$1 != 41\n');
    final $s13 = State('a');
    final $r21 = $r19($s13) as dynamic;
    expect($r21, isNotNull, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'a\'\nresult != null\n');
    expect($s13.position, 0, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'a\'\nstate.position = 0\n');
    expect($r21.$1, null, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'a\'\nresult.\$1 != null\n');
    final $s14 = State('');
    final $r22 = $r18($s14) as dynamic;
    expect($r22, isNotNull, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'\'\nresult != null\n');
    expect($s14.position, 0, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'\'\nstate.position = 0\n');
    expect($r22.$1, 41, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'\'\nresult.\$1 != 41\n');
    final $s15 = State('');
    final $r23 = $r19($s15) as dynamic;
    expect($r23, isNotNull, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'\'\nresult != null\n');
    expect($s15.position, 0, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'\'\nstate.position = 0\n');
    expect($r23.$1, null, reason: '{ const x = 41; }\n\$ = `const` { x }\n\'\'\nresult.\$1 != null\n');
  });
  ...
  test('Capture', () {
    ...
    expect($s2.farthestPosition, 0, reason: '<[a]>\n\'\'\nstate.farthestPosition = 0\n');
    expect($s2.position, 0, reason: '<[a]>\n\'\'\nstate.position = 0\n');
    final $e = $s2.getErrors().map((e) => '$e').toList()..sort();
    expect($e.length, 1, reason: '<[a]>\n\'\'\nerror count\n');
    expect($e, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '<[a]>\n\'\'\nerrors\n');
    final $s3 = State('');
    final $r5 = $r1($s3) as dynamic;
    expect($r5, isNull, reason: '<[a]>\n\'\'\nresult == null\n');
    expect($s3.farthestPosition, 0, reason: '<[a]>\n\'\'\nstate.farthestPosition = 0\n');
    expect($s3.position, 0, reason: '<[a]>\n\'\'\nstate.position = 0\n');
    final $e1 = $s3.getErrors().map((e) => '$e').toList()..sort();
    expect($e1.length, 1, reason: '<[a]>\n\'\'\nerror count\n');
    expect($e1, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '<[a]>\n\'\'\nerrors\n');
    final $s4 = State('z');
    final $r6 = $r($s4) as dynamic;
    expect($r6, isNull, reason: '<[a]>\n\'z\'\nresult == null\n');
    expect($s4.farthestPosition, 0, reason: '<[a]>\n\'z\'\nstate.farthestPosition = 0\n');
    expect($s4.position, 0, reason: '<[a]>\n\'z\'\nstate.position = 0\n');
    final $e2 = $s4.getErrors().map((e) => '$e').toList()..sort();
    expect($e2.length, 1, reason: '<[a]>\n\'z\'\nerror count\n');
    expect($e2, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '<[a]>\n\'z\'\nerrors\n');
    final $s5 = State('z');
    final $r7 = $r1($s5) as dynamic;
    expect($r7, isNull, reason: '<[a]>\n\'z\'\nresult == null\n');
    expect($s5.farthestPosition, 0, reason: '<[a]>\n\'z\'\nstate.farthestPosition = 0\n');
    expect($s5.position, 0, reason: '<[a]>\n\'z\'\nstate.position = 0\n');
    final $e3 = $s5.getErrors().map((e) => '$e').toList()..sort();
    expect($e3.length, 1, reason: '<[a]>\n\'z\'\nerror count\n');
    expect($e3, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '<[a]>\n\'z\'\nerrors\n');
  ...
  test('CharacterClass', () {
    ...
    expect($s70.position, 1, reason: '[\\u{30}-\\u{39}]\n\'0\'\nstate.position = 1\n');
    expect($r90.$1, 48, reason: '[\\u{30}-\\u{39}]\n\'0\'\nresult.\$1 != 48\n');
    final $s71 = State('0');
    final $r91 = $r89($s71) as dynamic;
    expect($r91, isNotNull, reason: '[\\u{30}-\\u{39}]\n\'0\'\nresult != null\n');
    expect($s71.position, 1, reason: '[\\u{30}-\\u{39}]\n\'0\'\nstate.position = 1\n');
    expect($r91.$1, null, reason: '[\\u{30}-\\u{39}]\n\'0\'\nresult.\$1 != null\n');
    final $s72 = State('9');
    final $r92 = $r88($s72) as dynamic;
    expect($r92, isNotNull, reason: '[\\u{30}-\\u{39}]\n\'9\'\nresult != null\n');
    expect($s72.position, 1, reason: '[\\u{30}-\\u{39}]\n\'9\'\nstate.position = 1\n');
    expect($r92.$1, 57, reason: '[\\u{30}-\\u{39}]\n\'9\'\nresult.\$1 != 57\n');
    final $s73 = State('9');
    final $r93 = $r89($s73) as dynamic;
    expect($r93, isNotNull, reason: '[\\u{30}-\\u{39}]\n\'9\'\nresult != null\n');
    expect($s73.position, 1, reason: '[\\u{30}-\\u{39}]\n\'9\'\nstate.position = 1\n');
    expect($r93.$1, null, reason: '[\\u{30}-\\u{39}]\n\'9\'\nresult.\$1 != null\n');
    final $s74 = State('');
    final $r94 = $r88($s74) as dynamic;
    expect($r94, isNull, reason: '[\\u{30}-\\u{39}]\n\'\'\nresult == null\n');
    expect($s74.farthestPosition, 0, reason: '[\\u{30}-\\u{39}]\n\'\'\nstate.farthestPosition = 0\n');
    expect($s74.position, 0, reason: '[\\u{30}-\\u{39}]\n\'\'\nstate.position = 0\n');
    final $e44 = $s74.getErrors().map((e) => '$e').toList()..sort();
    expect($e44.length, 1, reason: '[\\u{30}-\\u{39}]\n\'\'\nerror count\n');
    expect($e44, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[\\u{30}-\\u{39}]\n\'\'\nerrors\n');
    final $s75 = State('');
    final $r95 = $r89($s75) as dynamic;
    expect($r95, isNull, reason: '[\\u{30}-\\u{39}]\n\'\'\nresult == null\n');
    expect($s75.farthestPosition, 0, reason: '[\\u{30}-\\u{39}]\n\'\'\nstate.farthestPosition = 0\n');
    expect($s75.position, 0, reason: '[\\u{30}-\\u{39}]\n\'\'\nstate.position = 0\n');
    final $e45 = $s75.getErrors().map((e) => '$e').toList()..sort();
    expect($e45.length, 1, reason: '[\\u{30}-\\u{39}]\n\'\'\nerror count\n');
    expect($e45, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[\\u{30}-\\u{39}]\n\'\'\nerrors\n');
    final $s76 = State('a');
    final $r96 = $r88($s76) as dynamic;
    expect($r96, isNull, reason: '[\\u{30}-\\u{39}]\n\'a\'\nresult == null\n');
    expect($s76.farthestPosition, 0, reason: '[\\u{30}-\\u{39}]\n\'a\'\nstate.farthestPosition = 0\n');
    expect($s76.position, 0, reason: '[\\u{30}-\\u{39}]\n\'a\'\nstate.position = 0\n');
    final $e46 = $s76.getErrors().map((e) => '$e').toList()..sort();
    expect($e46.length, 1, reason: '[\\u{30}-\\u{39}]\n\'a\'\nerror count\n');
    expect($e46, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[\\u{30}-\\u{39}]\n\'a\'\nerrors\n');
    final $s77 = State('a');
    final $r97 = $r89($s77) as dynamic;
    expect($r97, isNull, reason: '[\\u{30}-\\u{39}]\n\'a\'\nresult == null\n');
    expect($s77.farthestPosition, 0, reason: '[\\u{30}-\\u{39}]\n\'a\'\nstate.farthestPosition = 0\n');
    expect($s77.position, 0, reason: '[\\u{30}-\\u{39}]\n\'a\'\nstate.position = 0\n');
    final $e47 = $s77.getErrors().map((e) => '$e').toList()..sort();
    expect($e47.length, 1, reason: '[\\u{30}-\\u{39}]\n\'a\'\nerror count\n');
    expect($e47, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[\\u{30}-\\u{39}]\n\'a\'\nerrors\n');
    ...
    expect($s98.position, 1, reason: '[^\\u{0}-\\u{9}]\n\'a\'\nstate.position = 1\n');
    expect($r126.$1, 97, reason: '[^\\u{0}-\\u{9}]\n\'a\'\nresult.\$1 != 97\n');
    final $s99 = State('a');
    final $r127 = $r125($s99) as dynamic;
    expect($r127, isNotNull, reason: '[^\\u{0}-\\u{9}]\n\'a\'\nresult != null\n');
    expect($s99.position, 1, reason: '[^\\u{0}-\\u{9}]\n\'a\'\nstate.position = 1\n');
    expect($r127.$1, null, reason: '[^\\u{0}-\\u{9}]\n\'a\'\nresult.\$1 != null\n');
    final $s100 = State('');
    final $r128 = $r124($s100) as dynamic;
    expect($r128, isNull, reason: '[^\\u{0}-\\u{9}]\n\'\'\nresult == null\n');
    expect($s100.farthestPosition, 0, reason: '[^\\u{0}-\\u{9}]\n\'\'\nstate.farthestPosition = 0\n');
    expect($s100.position, 0, reason: '[^\\u{0}-\\u{9}]\n\'\'\nstate.position = 0\n');
    final $e60 = $s100.getErrors().map((e) => '$e').toList()..sort();
    expect($e60.length, 1, reason: '[^\\u{0}-\\u{9}]\n\'\'\nerror count\n');
    expect($e60, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[^\\u{0}-\\u{9}]\n\'\'\nerrors\n');
    final $s101 = State('');
    final $r129 = $r125($s101) as dynamic;
    expect($r129, isNull, reason: '[^\\u{0}-\\u{9}]\n\'\'\nresult == null\n');
    expect($s101.farthestPosition, 0, reason: '[^\\u{0}-\\u{9}]\n\'\'\nstate.farthestPosition = 0\n');
    expect($s101.position, 0, reason: '[^\\u{0}-\\u{9}]\n\'\'\nstate.position = 0\n');
    final $e61 = $s101.getErrors().map((e) => '$e').toList()..sort();
    expect($e61.length, 1, reason: '[^\\u{0}-\\u{9}]\n\'\'\nerror count\n');
    expect($e61, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[^\\u{0}-\\u{9}]\n\'\'\nerrors\n');
    final $s102 = State(' ');
    final $r130 = $r124($s102) as dynamic;
    expect($r130, isNull, reason: '[^\\u{0}-\\u{9}]\n\' \'\nresult == null\n');
    expect($s102.farthestPosition, 0, reason: '[^\\u{0}-\\u{9}]\n\' \'\nstate.farthestPosition = 0\n');
    expect($s102.position, 0, reason: '[^\\u{0}-\\u{9}]\n\' \'\nstate.position = 0\n');
    final $e62 = $s102.getErrors().map((e) => '$e').toList()..sort();
    expect($e62.length, 1, reason: '[^\\u{0}-\\u{9}]\n\' \'\nerror count\n');
    expect($e62, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[^\\u{0}-\\u{9}]\n\' \'\nerrors\n');
    final $s103 = State(' ');
    final $r131 = $r125($s103) as dynamic;
    expect($r131, isNull, reason: '[^\\u{0}-\\u{9}]\n\' \'\nresult == null\n');
    expect($s103.farthestPosition, 0, reason: '[^\\u{0}-\\u{9}]\n\' \'\nstate.farthestPosition = 0\n');
    expect($s103.position, 0, reason: '[^\\u{0}-\\u{9}]\n\' \'\nstate.position = 0\n');
    final $e63 = $s103.getErrors().map((e) => '$e').toList()..sort();
    expect($e63.length, 1, reason: '[^\\u{0}-\\u{9}]\n\' \'\nerror count\n');
    expect($e63, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[^\\u{0}-\\u{9}]\n\' \'\nerrors\n');
    final $s104 = State('\t');
    final $r132 = $r124($s104) as dynamic;
    expect($r132, isNull, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nresult == null\n');
    expect($s104.farthestPosition, 0, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nstate.farthestPosition = 0\n');
    expect($s104.position, 0, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nstate.position = 0\n');
    final $e64 = $s104.getErrors().map((e) => '$e').toList()..sort();
    expect($e64.length, 1, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nerror count\n');
    expect($e64, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nerrors\n');
    final $s105 = State('\t');
    final $r133 = $r125($s105) as dynamic;
    expect($r133, isNull, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nresult == null\n');
    expect($s105.farthestPosition, 0, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nstate.farthestPosition = 0\n');
    expect($s105.position, 0, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nstate.position = 0\n');
    final $e65 = $s105.getErrors().map((e) => '$e').toList()..sort();
    expect($e65.length, 1, reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nerror count\n');
    expect($e65, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '[^\\u{0}-\\u{9}]\n\'\\t\'\nerrors\n');
  });
  ...
  test('Group', () {
    ...
    expect($s4.farthestPosition, 0, reason: '([a] / [z])\n\'\'\nstate.farthestPosition = 0\n');
    expect($s4.position, 0, reason: '([a] / [z])\n\'\'\nstate.position = 0\n');
    final $e = $s4.getErrors().map((e) => '$e').toList()..sort();
    expect($e.length, 1, reason: '([a] / [z])\n\'\'\nerror count\n');
    expect($e, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [z])\n\'\'\nerrors\n');
    final $s5 = State('');
    final $r7 = $r1($s5) as dynamic;
    expect($r7, isNull, reason: '([a] / [z])\n\'\'\nresult == null\n');
    expect($s5.farthestPosition, 0, reason: '([a] / [z])\n\'\'\nstate.farthestPosition = 0\n');
    expect($s5.position, 0, reason: '([a] / [z])\n\'\'\nstate.position = 0\n');
    final $e1 = $s5.getErrors().map((e) => '$e').toList()..sort();
    expect($e1.length, 1, reason: '([a] / [z])\n\'\'\nerror count\n');
    expect($e1, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [z])\n\'\'\nerrors\n');
    final $s6 = State('b');
    final $r8 = $r($s6) as dynamic;
    expect($r8, isNull, reason: '([a] / [z])\n\'b\'\nresult == null\n');
    expect($s6.farthestPosition, 0, reason: '([a] / [z])\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s6.position, 0, reason: '([a] / [z])\n\'b\'\nstate.position = 0\n');
    final $e2 = $s6.getErrors().map((e) => '$e').toList()..sort();
    expect($e2.length, 1, reason: '([a] / [z])\n\'b\'\nerror count\n');
    expect($e2, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [z])\n\'b\'\nerrors\n');
    final $s7 = State('b');
    final $r9 = $r1($s7) as dynamic;
    expect($r9, isNull, reason: '([a] / [z])\n\'b\'\nresult == null\n');
    expect($s7.farthestPosition, 0, reason: '([a] / [z])\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s7.position, 0, reason: '([a] / [z])\n\'b\'\nstate.position = 0\n');
    final $e3 = $s7.getErrors().map((e) => '$e').toList()..sort();
    expect($e3.length, 1, reason: '([a] / [z])\n\'b\'\nerror count\n');
    expect($e3, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [z])\n\'b\'\nerrors\n');
  });
  ...
  test('Literal', () {
    ...
    final $e = $s2.getErrors().map((e) => '$e').toList()..sort();
    expect($e.length, 1, reason: '\'abc\'\n\'\'\nerror count\n');
    expect($e, ['(end: 0, message: Expected: \'abc\', start: 0)'], reason: '\'abc\'\n\'\'\nerrors\n');
    final $s3 = State('');
    final $r5 = $r1($s3) as dynamic;
    expect($r5, isNull, reason: '\'abc\'\n\'\'\nresult == null\n');
    expect($s3.farthestPosition, 0, reason: '\'abc\'\n\'\'\nstate.farthestPosition = 0\n');
    ...
    final $e1 = $s3.getErrors().map((e) => '$e').toList()..sort();
    expect($e1.length, 1, reason: '\'abc\'\n\'\'\nerror count\n');
    expect($e1, ['(end: 0, message: Expected: \'abc\', start: 0)'], reason: '\'abc\'\n\'\'\nerrors\n');
    final $s4 = State('a');
    final $r6 = $r($s4) as dynamic;
    expect($r6, isNull, reason: '\'abc\'\n\'a\'\nresult == null\n');
    expect($s4.farthestPosition, 0, reason: '\'abc\'\n\'a\'\nstate.farthestPosition = 0\n');
    ...
    final $e2 = $s4.getErrors().map((e) => '$e').toList()..sort();
    expect($e2.length, 1, reason: '\'abc\'\n\'a\'\nerror count\n');
    expect($e2, ['(end: 0, message: Expected: \'abc\', start: 0)'], reason: '\'abc\'\n\'a\'\nerrors\n');
    final $s5 = State('a');
    final $r7 = $r1($s5) as dynamic;
    expect($r7, isNull, reason: '\'abc\'\n\'a\'\nresult == null\n');
    expect($s5.farthestPosition, 0, reason: '\'abc\'\n\'a\'\nstate.farthestPosition = 0\n');
    ...
    final $e3 = $s5.getErrors().map((e) => '$e').toList()..sort();
    expect($e3.length, 1, reason: '\'abc\'\n\'a\'\nerror count\n');
    expect($e3, ['(end: 0, message: Expected: \'abc\', start: 0)'], reason: '\'abc\'\n\'a\'\nerrors\n');
    ...
    final $r12 = $r8($s8) as dynamic;
    expect($r12, isNull, reason: '"abc"\n\'\'\nresult == null\n');
    expect($s8.farthestPosition, 0, reason: '"abc"\n\'\'\nstate.farthestPosition = 0\n');
    expect($s8.position, 0, reason: '"abc"\n\'\'\nstate.position = 0\n');
    final $e4 = $s8.getErrors().map((e) => '$e').toList()..sort();
    expect($e4.length, 1, reason: '"abc"\n\'\'\nerror count\n');
    expect($e4, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '"abc"\n\'\'\nerrors\n');
    final $s9 = State('');
    final $r13 = $r9($s9) as dynamic;
    expect($r13, isNull, reason: '"abc"\n\'\'\nresult == null\n');
    expect($s9.farthestPosition, 0, reason: '"abc"\n\'\'\nstate.farthestPosition = 0\n');
    ...
    expect($e5.length, 1, reason: '"abc"\n\'\'\nerror count\n');
    expect($e5, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '"abc"\n\'\'\nerrors\n');
    final $s10 = State('a');
    final $r14 = $r8($s10) as dynamic;
    expect($r14, isNull, reason: '"abc"\n\'a\'\nresult == null\n');
    expect($s10.farthestPosition, 0, reason: '"abc"\n\'a\'\nstate.farthestPosition = 0\n');
  ...
  test('NotPredicate', () {
    ...
    final $r2 = $r($s) as dynamic;
    expect($r2, isNotNull, reason: '! \'abc\'\n\$ = \'ab\'\n\n\'ab\'\nresult != null\n');
    expect($s.position, 2, reason: '! \'abc\'\n\$ = \'ab\'\n\n\'ab\'\nstate.position = 2\n');
    expect($r2.$1, 'ab', reason: '! \'abc\'\n\$ = \'ab\'\n\n\'ab\'\nresult.\$1 != \'ab\'\n');
    final $s1 = State('ab');
    final $r3 = $r1($s1) as dynamic;
    expect($r3, isNotNull, reason: '! \'abc\'\n\$ = \'ab\'\n\n\'ab\'\nresult != null\n');
    expect($s1.position, 2, reason: '! \'abc\'\n\$ = \'ab\'\n\n\'ab\'\nstate.position = 2\n');
    expect($r3.$1, null, reason: '! \'abc\'\n\$ = \'ab\'\n\n\'ab\'\nresult.\$1 != null\n');
    final $s2 = State('abc');
    final $r4 = $r($s2) as dynamic;
    expect($r4, isNull, reason: '! \'abc\'\n\$ = \'ab\'\n\n\'abc\'\nresult == null\n');
    ...
    final $s4 = State('abc');
    final $r8 = $r6($s4) as dynamic;
    expect($r8, isNotNull, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc\'\nresult != null\n');
    expect($s4.position, 3, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc\'\nstate.position = 3\n');
    expect($r8.$1, 'abc', reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc\'\nresult.\$1 != \'abc\'\n');
    final $s5 = State('abc');
    final $r9 = $r7($s5) as dynamic;
    expect($r9, isNotNull, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc\'\nresult != null\n');
    expect($s5.position, 3, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc\'\nstate.position = 3\n');
    expect($r9.$1, null, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc\'\nresult.\$1 != null\n');
    final $s6 = State('abc=>');
    final $r10 = $r6($s6) as dynamic;
    expect($r10, isNull, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nresult == null\n');
    expect($s6.farthestPosition, 3, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nstate.farthestPosition = 3\n');
    expect($s6.position, 0, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nstate.position = 0\n');
    final $e2 = $s6.getErrors().map((e) => '$e').toList()..sort();
    expect($e2.length, 1, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nerror count\n');
    expect($e2, ['(end: 3, message: Unexpected input data, start: 3)'], reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nerrors\n');
    final $s7 = State('abc=>');
    final $r11 = $r7($s7) as dynamic;
    expect($r11, isNull, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nresult == null\n');
    expect($s7.farthestPosition, 3, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nstate.farthestPosition = 3\n');
    expect($s7.position, 0, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nstate.position = 0\n');
    final $e3 = $s7.getErrors().map((e) => '$e').toList()..sort();
    expect($e3.length, 1, reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nerror count\n');
    expect($e3, ['(end: 3, message: Unexpected input data, start: 3)'], reason: '\$ = \'abc\'\n! \'=>\'\n\n\'abc=>\'\nerrors\n');
    final $r12 = parser.parseNotPredicate2;
    final $r13 = parser.parseNotPredicateVoid2;
    final $s8 = State('');
    final $r14 = $r12($s8) as dynamic;
    expect($r14, isNotNull, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'\'\nresult != null\n');
    expect($s8.position, 0, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'\'\nstate.position = 0\n');
    expect($r14.$1, <int>[], reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'\'\nresult.\$1 != <int>[]\n');
    final $s9 = State('');
    final $r15 = $r13($s9) as dynamic;
    expect($r15, isNotNull, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'\'\nresult != null\n');
    expect($s9.position, 0, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'\'\nstate.position = 0\n');
    expect($r15.$1, null, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'\'\nresult.\$1 != null\n');
    final $s10 = State('a');
    final $r16 = $r12($s10) as dynamic;
    expect($r16, isNotNull, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'a\'\nresult != null\n');
    expect($s10.position, 1, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'a\'\nstate.position = 1\n');
    expect($r16.$1, [97], reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'a\'\nresult.\$1 != [97]\n');
    final $s11 = State('a');
    final $r17 = $r13($s11) as dynamic;
    expect($r17, isNotNull, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'a\'\nresult != null\n');
    expect($s11.position, 1, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'a\'\nstate.position = 1\n');
    expect($r17.$1, null, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'a\'\nresult.\$1 != null\n');
    final $s12 = State('aa');
    final $r18 = $r12($s12) as dynamic;
    expect($r18, isNull, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nresult == null\n');
    expect($s12.farthestPosition, 0, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nstate.farthestPosition = 0\n');
    expect($s12.position, 0, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nstate.position = 0\n');
    final $e4 = $s12.getErrors().map((e) => '$e').toList()..sort();
    expect($e4.length, 1, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nerror count\n');
    expect($e4, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nerrors\n');
    final $s13 = State('aa');
    final $r19 = $r13($s13) as dynamic;
    expect($r19, isNull, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nresult == null\n');
    expect($s13.farthestPosition, 0, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nstate.farthestPosition = 0\n');
    expect($s13.position, 0, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nstate.position = 0\n');
    final $e5 = $s13.getErrors().map((e) => '$e').toList()..sort();
    expect($e5.length, 1, reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nerror count\n');
    expect($e5, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '! @while (2) {\n  [a]\n}\n\$ = [a]*\n\n\'aa\'\nerrors\n');
    final $r20 = parser.parseNotPredicate3;
    final $s14 = State('a');
    final $r21 = $r20($s14) as dynamic;
    expect($r21, isNull, reason: '!\'\'\n\'a\'\nresult == null\n');
    expect($s14.farthestPosition, 0, reason: '!\'\'\n\'a\'\nstate.farthestPosition = 0\n');
    expect($s14.position, 0, reason: '!\'\'\n\'a\'\nstate.position = 0\n');
    final $e6 = $s14.getErrors().map((e) => '$e').toList()..sort();
    expect($e6.length, 1, reason: '!\'\'\n\'a\'\nerror count\n');
    expect($e6, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '!\'\'\n\'a\'\nerrors\n');
    final $s15 = State('');
    final $r22 = $r20($s15) as dynamic;
    expect($r22, isNull, reason: '!\'\'\n\'\'\nresult == null\n');
    expect($s15.farthestPosition, 0, reason: '!\'\'\n\'\'\nstate.farthestPosition = 0\n');
    expect($s15.position, 0, reason: '!\'\'\n\'\'\nstate.position = 0\n');
    final $e7 = $s15.getErrors().map((e) => '$e').toList()..sort();
    expect($e7.length, 1, reason: '!\'\'\n\'\'\nerror count\n');
    expect($e7, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '!\'\'\n\'\'\nerrors\n');
    final $r23 = parser.parseNotPredicate4;
    final $s16 = State('a');
    final $r24 = $r23($s16) as dynamic;
    expect($r24, isNull, reason: '![a]?\n\'a\'\nresult == null\n');
    expect($s16.farthestPosition, 0, reason: '![a]?\n\'a\'\nstate.farthestPosition = 0\n');
    ...
    final $r25 = $r23($s17) as dynamic;
    expect($r25, isNull, reason: '![a]?\n\'b\'\nresult == null\n');
    expect($s17.farthestPosition, 0, reason: '![a]?\n\'b\'\nstate.farthestPosition = 0\n');
  ...
  test('OneOrMore', () {
    ...
    expect($s6.farthestPosition, 0, reason: '[a]+\n\'b\'\nstate.farthestPosition = 0\n');
    ...
    expect($r18.$1, [122, 97], reason: '([a] / [z])+\n\'za\'\nresult.\$1 != [122, 97]\n');
    final $s15 = State('za');
    ...
    expect($s16.farthestPosition, 0, reason: '([a] / [z])+\n\'\'\nstate.farthestPosition = 0\n');
    ...
    expect($s17.farthestPosition, 0, reason: '([a] / [z])+\n\'\'\nstate.farthestPosition = 0\n');
    ...
    expect($s18.farthestPosition, 0, reason: '([a] / [z])+\n\'b\'\nstate.farthestPosition = 0\n');
  ...
  test('Optional', () {
    ...
    expect($r32, isNotNull, reason: '([a] / [b])? \$ = [c]\n\'ac\'\nresult != null\n');
    expect($s22.position, 2, reason: '([a] / [b])? \$ = [c]\n\'ac\'\nstate.position = 2\n');
    expect($r32.$1, 99, reason: '([a] / [b])? \$ = [c]\n\'ac\'\nresult.\$1 != 99\n');
    final $s23 = State('ac');
    final $r33 = $r31($s23) as dynamic;
    expect($r33, isNotNull, reason: '([a] / [b])? \$ = [c]\n\'ac\'\nresult != null\n');
    expect($s23.position, 2, reason: '([a] / [b])? \$ = [c]\n\'ac\'\nstate.position = 2\n');
    expect($r33.$1, null, reason: '([a] / [b])? \$ = [c]\n\'ac\'\nresult.\$1 != null\n');
    final $s24 = State('bc');
    final $r34 = $r30($s24) as dynamic;
    expect($r34, isNotNull, reason: '([a] / [b])? \$ = [c]\n\'bc\'\nresult != null\n');
    expect($s24.position, 2, reason: '([a] / [b])? \$ = [c]\n\'bc\'\nstate.position = 2\n');
    expect($r34.$1, 99, reason: '([a] / [b])? \$ = [c]\n\'bc\'\nresult.\$1 != 99\n');
    final $s25 = State('bc');
    final $r35 = $r31($s25) as dynamic;
    expect($r35, isNotNull, reason: '([a] / [b])? \$ = [c]\n\'bc\'\nresult != null\n');
    expect($s25.position, 2, reason: '([a] / [b])? \$ = [c]\n\'bc\'\nstate.position = 2\n');
    expect($r35.$1, null, reason: '([a] / [b])? \$ = [c]\n\'bc\'\nresult.\$1 != null\n');
    final $s26 = State('c');
    final $r36 = $r30($s26) as dynamic;
    expect($r36, isNotNull, reason: '([a] / [b])? \$ = [c]\n\'c\'\nresult != null\n');
    expect($s26.position, 1, reason: '([a] / [b])? \$ = [c]\n\'c\'\nstate.position = 1\n');
    expect($r36.$1, 99, reason: '([a] / [b])? \$ = [c]\n\'c\'\nresult.\$1 != 99\n');
    final $s27 = State('c');
    final $r37 = $r31($s27) as dynamic;
    expect($r37, isNotNull, reason: '([a] / [b])? \$ = [c]\n\'c\'\nresult != null\n');
    expect($s27.position, 1, reason: '([a] / [b])? \$ = [c]\n\'c\'\nstate.position = 1\n');
    expect($r37.$1, null, reason: '([a] / [b])? \$ = [c]\n\'c\'\nresult.\$1 != null\n');
    final $s28 = State('');
    final $r38 = $r30($s28) as dynamic;
    expect($r38, isNull, reason: '([a] / [b])? \$ = [c]\n\'\'\nresult == null\n');
    expect($s28.farthestPosition, 0, reason: '([a] / [b])? \$ = [c]\n\'\'\nstate.farthestPosition = 0\n');
    expect($s28.position, 0, reason: '([a] / [b])? \$ = [c]\n\'\'\nstate.position = 0\n');
    final $e = $s28.getErrors().map((e) => '$e').toList()..sort();
    expect($e.length, 1, reason: '([a] / [b])? \$ = [c]\n\'\'\nerror count\n');
    expect($e, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [b])? \$ = [c]\n\'\'\nerrors\n');
    final $s29 = State('');
    final $r39 = $r31($s29) as dynamic;
    expect($r39, isNull, reason: '([a] / [b])? \$ = [c]\n\'\'\nresult == null\n');
    expect($s29.farthestPosition, 0, reason: '([a] / [b])? \$ = [c]\n\'\'\nstate.farthestPosition = 0\n');
    expect($s29.position, 0, reason: '([a] / [b])? \$ = [c]\n\'\'\nstate.position = 0\n');
    final $e1 = $s29.getErrors().map((e) => '$e').toList()..sort();
    expect($e1.length, 1, reason: '([a] / [b])? \$ = [c]\n\'\'\nerror count\n');
    expect($e1, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [b])? \$ = [c]\n\'\'\nerrors\n');
  });
  ...
  test('Predicate', () {
    ...
    expect($s8.position, 0, reason: '& (a = { false })\n\'a\'\nstate.position = 0\n');
    expect($r13.$1, null, reason: '& (a = { false })\n\'a\'\nresult.\$1 != null\n');
    final $s9 = State('');
    final $r14 = $r12($s9) as dynamic;
    expect($r14, isNotNull, reason: '& (a = { false })\n\'\'\nresult != null\n');
    expect($s9.position, 0, reason: '& (a = { false })\n\'\'\nstate.position = 0\n');
    expect($r14.$1, null, reason: '& (a = { false })\n\'\'\nresult.\$1 != null\n');
  });
  ...
  test('Sequence', () {
    ...
    final $s = State('123');
    final $r2 = $r($s) as dynamic;
    expect($r2, isNotNull, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'123\'\nresult != null\n');
    expect($s.position, 3, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'123\'\nstate.position = 3\n');
    expect($r2.$1, 6, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'123\'\nresult.\$1 != 6\n');
    final $s1 = State('123');
    final $r3 = $r1($s1) as dynamic;
    expect($r3, isNotNull, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'123\'\nresult != null\n');
    expect($s1.position, 3, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'123\'\nstate.position = 3\n');
    expect($r3.$1, null, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'123\'\nresult.\$1 != null\n');
    final $s2 = State('12');
    final $r4 = $r($s2) as dynamic;
    expect($r4, isNull, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nresult == null\n');
    expect($s2.farthestPosition, 2, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nstate.farthestPosition = 2\n');
    expect($s2.position, 0, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nstate.position = 0\n');
    final $e = $s2.getErrors().map((e) => '$e').toList()..sort();
    expect($e.length, 1, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nerror count\n');
    expect($e, ['(end: 2, message: Unexpected input data, start: 2)'], reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nerrors\n');
    final $s3 = State('12');
    final $r5 = $r1($s3) as dynamic;
    expect($r5, isNull, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nresult == null\n');
    expect($s3.farthestPosition, 2, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nstate.farthestPosition = 2\n');
    expect($s3.position, 0, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nstate.position = 0\n');
    final $e1 = $s3.getErrors().map((e) => '$e').toList()..sort();
    expect($e1.length, 1, reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nerror count\n');
    expect($e1, ['(end: 2, message: Unexpected input data, start: 2)'], reason: 'a = [0-9]\nb = [0-9]\nc = [0-9]\n\$ = { a -48 + b - 48 + c - 48 }\n\'12\'\nerrors\n');
    ...
    expect($s4.position, 3, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'abc\'\nstate.position = 3\n');
    expect($r8.$1, 'abc', reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'abc\'\nresult.\$1 != \'abc\'\n');
    final $s5 = State('abc');
    final $r9 = $r7($s5) as dynamic;
    expect($r9, isNotNull, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'abc\'\nresult != null\n');
    expect($s5.position, 3, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'abc\'\nstate.position = 3\n');
    expect($r9.$1, null, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'abc\'\nresult.\$1 != null\n');
    final $s6 = State('');
    final $r10 = $r6($s6) as dynamic;
    expect($r10, isNull, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'\'\nresult == null\n');
    ...
    final $e2 = $s6.getErrors().map((e) => '$e').toList()..sort();
    expect($e2.length, 1, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'\'\nerror count\n');
    expect($e2, ['(end: 0, message: Expected: \'abc\', start: 0)'], reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'\'\nerrors\n');
    final $s7 = State('');
    final $r11 = $r7($s7) as dynamic;
    expect($r11, isNull, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'\'\nresult == null\n');
    expect($s7.farthestPosition, 0, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'\'\nstate.farthestPosition = 0\n');
    ...
    final $e3 = $s7.getErrors().map((e) => '$e').toList()..sort();
    expect($e3.length, 1, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'\'\nerror count\n');
    expect($e3, ['(end: 0, message: Expected: \'abc\', start: 0)'], reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'\'\nerrors\n');
    final $s8 = State('a');
    final $r12 = $r6($s8) as dynamic;
    expect($r12, isNull, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nresult == null\n');
    expect($s8.farthestPosition, 1, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s8.position, 0, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nstate.position = 0\n');
    final $e4 = $s8.getErrors().map((e) => '$e').toList()..sort();
    expect($e4.length, 3, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nerror count\n');
    expect($e4, ['(end: 0, message: Start, start: 0)', '(end: 1, message: End, start: 1)', '(end: 1, message: Full, start: 0)'], reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nerrors\n');
    final $s9 = State('a');
    final $r13 = $r7($s9) as dynamic;
    expect($r13, isNull, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nresult == null\n');
    expect($s9.farthestPosition, 1, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s9.position, 0, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nstate.position = 0\n');
    final $e5 = $s9.getErrors().map((e) => '$e').toList()..sort();
    expect($e5.length, 3, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nerror count\n');
    expect($e5, ['(end: 0, message: Start, start: 0)', '(end: 1, message: End, start: 1)', '(end: 1, message: Full, start: 0)'], reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'a\'\nerrors\n');
    final $s10 = State('ab');
    final $r14 = $r6($s10) as dynamic;
    expect($r14, isNull, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nresult == null\n');
    expect($s10.farthestPosition, 2, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nstate.farthestPosition = 2\n');
    expect($s10.position, 0, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nstate.position = 0\n');
    final $e6 = $s10.getErrors().map((e) => '$e').toList()..sort();
    expect($e6.length, 3, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nerror count\n');
    expect($e6, ['(end: 0, message: Start, start: 0)', '(end: 2, message: End, start: 2)', '(end: 2, message: Full, start: 0)'], reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nerrors\n');
    final $s11 = State('ab');
    final $r15 = $r7($s11) as dynamic;
    expect($r15, isNull, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nresult == null\n');
    expect($s11.farthestPosition, 2, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nstate.farthestPosition = 2\n');
    expect($s11.position, 0, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nstate.position = 0\n');
    final $e7 = $s11.getErrors().map((e) => '$e').toList()..sort();
    expect($e7.length, 3, reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nerror count\n');
    expect($e7, ['(end: 0, message: Start, start: 0)', '(end: 2, message: End, start: 2)', '(end: 2, message: Full, start: 0)'], reason: '[a]\n[b]\n[c]\n\$ = `const` { \'abc\' }\n~ {\n  state.errorExpected(\'abc\');\n  state.errorIncorrect(\'Full\', true);\n  state.errorIncorrect(\'End\', false);\n  state.errorIncorrect(\'Start\', null);\n}\n\'ab\'\nerrors\n');
  });
  ...
  test('While', () {
    ...
    final $s = State('a');
    final $r2 = $r($s) as dynamic;
    expect($r2, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s.position, 1, reason: '@while (0) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r2.$1, [97], reason: '@while (0) {\n  [a]\n}\n\'a\'\nresult.\$1 != [97]\n');
    final $s1 = State('a');
    final $r3 = $r1($s1) as dynamic;
    expect($r3, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s1.position, 1, reason: '@while (0) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r3.$1, null, reason: '@while (0) {\n  [a]\n}\n\'a\'\nresult.\$1 != null\n');
    final $s2 = State('aa');
    final $r4 = $r($s2) as dynamic;
    expect($r4, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s2.position, 2, reason: '@while (0) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r4.$1, [97, 97], reason: '@while (0) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s3 = State('aa');
    final $r5 = $r1($s3) as dynamic;
    expect($r5, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s3.position, 2, reason: '@while (0) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r5.$1, null, reason: '@while (0) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s4 = State('');
    final $r6 = $r($s4) as dynamic;
    expect($r6, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'\'\nresult != null\n');
    expect($s4.position, 0, reason: '@while (0) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    expect($r6.$1, <int>[], reason: '@while (0) {\n  [a]\n}\n\'\'\nresult.\$1 != <int>[]\n');
    final $s5 = State('');
    final $r7 = $r1($s5) as dynamic;
    expect($r7, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'\'\nresult != null\n');
    expect($s5.position, 0, reason: '@while (0) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    expect($r7.$1, null, reason: '@while (0) {\n  [a]\n}\n\'\'\nresult.\$1 != null\n');
    final $s6 = State('b');
    final $r8 = $r($s6) as dynamic;
    expect($r8, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'b\'\nresult != null\n');
    expect($s6.position, 0, reason: '@while (0) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    expect($r8.$1, <int>[], reason: '@while (0) {\n  [a]\n}\n\'b\'\nresult.\$1 != <int>[]\n');
    final $s7 = State('b');
    final $r9 = $r1($s7) as dynamic;
    expect($r9, isNotNull, reason: '@while (0) {\n  [a]\n}\n\'b\'\nresult != null\n');
    expect($s7.position, 0, reason: '@while (0) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    expect($r9.$1, null, reason: '@while (0) {\n  [a]\n}\n\'b\'\nresult.\$1 != null\n');
    final $r10 = parser.parseWhile1;
    final $r11 = parser.parseWhileVoid1;
    final $s8 = State('a');
    final $r12 = $r10($s8) as dynamic;
    expect($r12, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'a\'\nresult != null\n');
    expect($s8.position, 1, reason: '@while (0) {\n  [a] / [z]\n}\n\'a\'\nstate.position = 1\n');
    expect($r12.$1, [97], reason: '@while (0) {\n  [a] / [z]\n}\n\'a\'\nresult.\$1 != [97]\n');
    final $s9 = State('a');
    final $r13 = $r11($s9) as dynamic;
    expect($r13, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'a\'\nresult != null\n');
    expect($s9.position, 1, reason: '@while (0) {\n  [a] / [z]\n}\n\'a\'\nstate.position = 1\n');
    expect($r13.$1, null, reason: '@while (0) {\n  [a] / [z]\n}\n\'a\'\nresult.\$1 != null\n');
    final $s10 = State('aa');
    final $r14 = $r10($s10) as dynamic;
    expect($r14, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'aa\'\nresult != null\n');
    expect($s10.position, 2, reason: '@while (0) {\n  [a] / [z]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r14.$1, [97, 97], reason: '@while (0) {\n  [a] / [z]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s11 = State('aa');
    final $r15 = $r11($s11) as dynamic;
    expect($r15, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'aa\'\nresult != null\n');
    expect($s11.position, 2, reason: '@while (0) {\n  [a] / [z]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r15.$1, null, reason: '@while (0) {\n  [a] / [z]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s12 = State('z');
    final $r16 = $r10($s12) as dynamic;
    expect($r16, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'z\'\nresult != null\n');
    expect($s12.position, 1, reason: '@while (0) {\n  [a] / [z]\n}\n\'z\'\nstate.position = 1\n');
    expect($r16.$1, [122], reason: '@while (0) {\n  [a] / [z]\n}\n\'z\'\nresult.\$1 != [122]\n');
    final $s13 = State('z');
    final $r17 = $r11($s13) as dynamic;
    expect($r17, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'z\'\nresult != null\n');
    expect($s13.position, 1, reason: '@while (0) {\n  [a] / [z]\n}\n\'z\'\nstate.position = 1\n');
    expect($r17.$1, null, reason: '@while (0) {\n  [a] / [z]\n}\n\'z\'\nresult.\$1 != null\n');
    final $s14 = State('za');
    final $r18 = $r10($s14) as dynamic;
    expect($r18, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'za\'\nresult != null\n');
    expect($s14.position, 2, reason: '@while (0) {\n  [a] / [z]\n}\n\'za\'\nstate.position = 2\n');
    expect($r18.$1, [122, 97], reason: '@while (0) {\n  [a] / [z]\n}\n\'za\'\nresult.\$1 != [122, 97]\n');
    final $s15 = State('za');
    final $r19 = $r11($s15) as dynamic;
    expect($r19, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'za\'\nresult != null\n');
    expect($s15.position, 2, reason: '@while (0) {\n  [a] / [z]\n}\n\'za\'\nstate.position = 2\n');
    expect($r19.$1, null, reason: '@while (0) {\n  [a] / [z]\n}\n\'za\'\nresult.\$1 != null\n');
    final $s16 = State('');
    final $r20 = $r10($s16) as dynamic;
    expect($r20, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'\'\nresult != null\n');
    expect($s16.position, 0, reason: '@while (0) {\n  [a] / [z]\n}\n\'\'\nstate.position = 0\n');
    expect($r20.$1, <int>[], reason: '@while (0) {\n  [a] / [z]\n}\n\'\'\nresult.\$1 != <int>[]\n');
    final $s17 = State('');
    final $r21 = $r11($s17) as dynamic;
    expect($r21, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'\'\nresult != null\n');
    expect($s17.position, 0, reason: '@while (0) {\n  [a] / [z]\n}\n\'\'\nstate.position = 0\n');
    expect($r21.$1, null, reason: '@while (0) {\n  [a] / [z]\n}\n\'\'\nresult.\$1 != null\n');
    final $s18 = State('b');
    final $r22 = $r10($s18) as dynamic;
    expect($r22, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'b\'\nresult != null\n');
    expect($s18.position, 0, reason: '@while (0) {\n  [a] / [z]\n}\n\'b\'\nstate.position = 0\n');
    expect($r22.$1, <int>[], reason: '@while (0) {\n  [a] / [z]\n}\n\'b\'\nresult.\$1 != <int>[]\n');
    final $s19 = State('b');
    final $r23 = $r11($s19) as dynamic;
    expect($r23, isNotNull, reason: '@while (0) {\n  [a] / [z]\n}\n\'b\'\nresult != null\n');
    expect($s19.position, 0, reason: '@while (0) {\n  [a] / [z]\n}\n\'b\'\nstate.position = 0\n');
    expect($r23.$1, null, reason: '@while (0) {\n  [a] / [z]\n}\n\'b\'\nresult.\$1 != null\n');
    final $r24 = parser.parseWhile2;
    final $r25 = parser.parseWhileVoid2;
    final $s20 = State('a');
    final $r26 = $r24($s20) as dynamic;
    expect($r26, isNotNull, reason: '@while (1) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s20.position, 1, reason: '@while (1) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r26.$1, [97], reason: '@while (1) {\n  [a]\n}\n\'a\'\nresult.\$1 != [97]\n');
    final $s21 = State('a');
    final $r27 = $r25($s21) as dynamic;
    expect($r27, isNotNull, reason: '@while (1) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s21.position, 1, reason: '@while (1) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r27.$1, null, reason: '@while (1) {\n  [a]\n}\n\'a\'\nresult.\$1 != null\n');
    final $s22 = State('aa');
    final $r28 = $r24($s22) as dynamic;
    expect($r28, isNotNull, reason: '@while (1) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s22.position, 2, reason: '@while (1) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r28.$1, [97, 97], reason: '@while (1) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s23 = State('aa');
    final $r29 = $r25($s23) as dynamic;
    expect($r29, isNotNull, reason: '@while (1) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s23.position, 2, reason: '@while (1) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r29.$1, null, reason: '@while (1) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s24 = State('');
    final $r30 = $r24($s24) as dynamic;
    expect($r30, isNull, reason: '@while (1) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s24.farthestPosition, 0, reason: '@while (1) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s24.position, 0, reason: '@while (1) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e = $s24.getErrors().map((e) => '$e').toList()..sort();
    expect($e.length, 1, reason: '@while (1) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s25 = State('');
    final $r31 = $r25($s25) as dynamic;
    expect($r31, isNull, reason: '@while (1) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s25.farthestPosition, 0, reason: '@while (1) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s25.position, 0, reason: '@while (1) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e1 = $s25.getErrors().map((e) => '$e').toList()..sort();
    expect($e1.length, 1, reason: '@while (1) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e1, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s26 = State('b');
    final $r32 = $r24($s26) as dynamic;
    expect($r32, isNull, reason: '@while (1) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s26.farthestPosition, 0, reason: '@while (1) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s26.position, 0, reason: '@while (1) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e2 = $s26.getErrors().map((e) => '$e').toList()..sort();
    expect($e2.length, 1, reason: '@while (1) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e2, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $s27 = State('b');
    final $r33 = $r25($s27) as dynamic;
    expect($r33, isNull, reason: '@while (1) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s27.farthestPosition, 0, reason: '@while (1) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s27.position, 0, reason: '@while (1) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e3 = $s27.getErrors().map((e) => '$e').toList()..sort();
    expect($e3.length, 1, reason: '@while (1) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e3, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $r34 = parser.parseWhile3;
    final $r35 = parser.parseWhileVoid3;
    final $s28 = State('a');
    final $r36 = $r34($s28) as dynamic;
    expect($r36, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'a\'\nresult != null\n');
    expect($s28.position, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'a\'\nstate.position = 1\n');
    expect($r36.$1, [97], reason: '@while (1) {\n  [a] / [z]\n}\n\'a\'\nresult.\$1 != [97]\n');
    final $s29 = State('a');
    final $r37 = $r35($s29) as dynamic;
    expect($r37, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'a\'\nresult != null\n');
    expect($s29.position, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'a\'\nstate.position = 1\n');
    expect($r37.$1, null, reason: '@while (1) {\n  [a] / [z]\n}\n\'a\'\nresult.\$1 != null\n');
    final $s30 = State('aa');
    final $r38 = $r34($s30) as dynamic;
    expect($r38, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'aa\'\nresult != null\n');
    expect($s30.position, 2, reason: '@while (1) {\n  [a] / [z]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r38.$1, [97, 97], reason: '@while (1) {\n  [a] / [z]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s31 = State('aa');
    final $r39 = $r35($s31) as dynamic;
    expect($r39, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'aa\'\nresult != null\n');
    expect($s31.position, 2, reason: '@while (1) {\n  [a] / [z]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r39.$1, null, reason: '@while (1) {\n  [a] / [z]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s32 = State('z');
    final $r40 = $r34($s32) as dynamic;
    expect($r40, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'z\'\nresult != null\n');
    expect($s32.position, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'z\'\nstate.position = 1\n');
    expect($r40.$1, [122], reason: '@while (1) {\n  [a] / [z]\n}\n\'z\'\nresult.\$1 != [122]\n');
    final $s33 = State('z');
    final $r41 = $r35($s33) as dynamic;
    expect($r41, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'z\'\nresult != null\n');
    expect($s33.position, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'z\'\nstate.position = 1\n');
    expect($r41.$1, null, reason: '@while (1) {\n  [a] / [z]\n}\n\'z\'\nresult.\$1 != null\n');
    final $s34 = State('za');
    final $r42 = $r34($s34) as dynamic;
    expect($r42, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'za\'\nresult != null\n');
    expect($s34.position, 2, reason: '@while (1) {\n  [a] / [z]\n}\n\'za\'\nstate.position = 2\n');
    expect($r42.$1, [122, 97], reason: '@while (1) {\n  [a] / [z]\n}\n\'za\'\nresult.\$1 != [122, 97]\n');
    final $s35 = State('za');
    final $r43 = $r35($s35) as dynamic;
    expect($r43, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'za\'\nresult != null\n');
    expect($s35.position, 2, reason: '@while (1) {\n  [a] / [z]\n}\n\'za\'\nstate.position = 2\n');
    expect($r43.$1, null, reason: '@while (1) {\n  [a] / [z]\n}\n\'za\'\nresult.\$1 != null\n');
    final $s36 = State('zz');
    final $r44 = $r34($s36) as dynamic;
    expect($r44, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'zz\'\nresult != null\n');
    expect($s36.position, 2, reason: '@while (1) {\n  [a] / [z]\n}\n\'zz\'\nstate.position = 2\n');
    expect($r44.$1, [122, 122], reason: '@while (1) {\n  [a] / [z]\n}\n\'zz\'\nresult.\$1 != [122, 122]\n');
    final $s37 = State('zz');
    final $r45 = $r35($s37) as dynamic;
    expect($r45, isNotNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'zz\'\nresult != null\n');
    expect($s37.position, 2, reason: '@while (1) {\n  [a] / [z]\n}\n\'zz\'\nstate.position = 2\n');
    expect($r45.$1, null, reason: '@while (1) {\n  [a] / [z]\n}\n\'zz\'\nresult.\$1 != null\n');
    final $s38 = State('');
    final $r46 = $r34($s38) as dynamic;
    expect($r46, isNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nresult == null\n');
    expect($s38.farthestPosition, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s38.position, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nstate.position = 0\n');
    final $e4 = $s38.getErrors().map((e) => '$e').toList()..sort();
    expect($e4.length, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nerror count\n');
    expect($e4, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nerrors\n');
    final $s39 = State('');
    final $r47 = $r35($s39) as dynamic;
    expect($r47, isNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nresult == null\n');
    expect($s39.farthestPosition, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s39.position, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nstate.position = 0\n');
    final $e5 = $s39.getErrors().map((e) => '$e').toList()..sort();
    expect($e5.length, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nerror count\n');
    expect($e5, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a] / [z]\n}\n\'\'\nerrors\n');
    final $s40 = State('b');
    final $r48 = $r34($s40) as dynamic;
    expect($r48, isNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nresult == null\n');
    expect($s40.farthestPosition, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s40.position, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nstate.position = 0\n');
    final $e6 = $s40.getErrors().map((e) => '$e').toList()..sort();
    expect($e6.length, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nerror count\n');
    expect($e6, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nerrors\n');
    final $s41 = State('b');
    final $r49 = $r35($s41) as dynamic;
    expect($r49, isNull, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nresult == null\n');
    expect($s41.farthestPosition, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s41.position, 0, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nstate.position = 0\n');
    final $e7 = $s41.getErrors().map((e) => '$e').toList()..sort();
    expect($e7.length, 1, reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nerror count\n');
    expect($e7, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1) {\n  [a] / [z]\n}\n\'b\'\nerrors\n');
    final $r50 = parser.parseWhile4;
    final $r51 = parser.parseWhileVoid4;
    final $s42 = State('aa');
    final $r52 = $r50($s42) as dynamic;
    expect($r52, isNotNull, reason: '@while (2) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s42.position, 2, reason: '@while (2) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r52.$1, [97, 97], reason: '@while (2) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s43 = State('aa');
    final $r53 = $r51($s43) as dynamic;
    expect($r53, isNotNull, reason: '@while (2) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s43.position, 2, reason: '@while (2) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r53.$1, null, reason: '@while (2) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s44 = State('aaa');
    final $r54 = $r50($s44) as dynamic;
    expect($r54, isNotNull, reason: '@while (2) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s44.position, 3, reason: '@while (2) {\n  [a]\n}\n\'aaa\'\nstate.position = 3\n');
    expect($r54.$1, [97, 97, 97], reason: '@while (2) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != [97, 97, 97]\n');
    final $s45 = State('aaa');
    final $r55 = $r51($s45) as dynamic;
    expect($r55, isNotNull, reason: '@while (2) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s45.position, 3, reason: '@while (2) {\n  [a]\n}\n\'aaa\'\nstate.position = 3\n');
    expect($r55.$1, null, reason: '@while (2) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != null\n');
    final $s46 = State('');
    final $r56 = $r50($s46) as dynamic;
    expect($r56, isNull, reason: '@while (2) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s46.farthestPosition, 0, reason: '@while (2) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s46.position, 0, reason: '@while (2) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e8 = $s46.getErrors().map((e) => '$e').toList()..sort();
    expect($e8.length, 1, reason: '@while (2) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e8, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s47 = State('');
    final $r57 = $r51($s47) as dynamic;
    expect($r57, isNull, reason: '@while (2) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s47.farthestPosition, 0, reason: '@while (2) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s47.position, 0, reason: '@while (2) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e9 = $s47.getErrors().map((e) => '$e').toList()..sort();
    expect($e9.length, 1, reason: '@while (2) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e9, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s48 = State('a');
    final $r58 = $r50($s48) as dynamic;
    expect($r58, isNull, reason: '@while (2) {\n  [a]\n}\n\'a\'\nresult == null\n');
    expect($s48.farthestPosition, 1, reason: '@while (2) {\n  [a]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s48.position, 0, reason: '@while (2) {\n  [a]\n}\n\'a\'\nstate.position = 0\n');
    final $e10 = $s48.getErrors().map((e) => '$e').toList()..sort();
    expect($e10.length, 1, reason: '@while (2) {\n  [a]\n}\n\'a\'\nerror count\n');
    expect($e10, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2) {\n  [a]\n}\n\'a\'\nerrors\n');
    final $s49 = State('a');
    final $r59 = $r51($s49) as dynamic;
    expect($r59, isNull, reason: '@while (2) {\n  [a]\n}\n\'a\'\nresult == null\n');
    expect($s49.farthestPosition, 1, reason: '@while (2) {\n  [a]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s49.position, 0, reason: '@while (2) {\n  [a]\n}\n\'a\'\nstate.position = 0\n');
    final $e11 = $s49.getErrors().map((e) => '$e').toList()..sort();
    expect($e11.length, 1, reason: '@while (2) {\n  [a]\n}\n\'a\'\nerror count\n');
    expect($e11, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2) {\n  [a]\n}\n\'a\'\nerrors\n');
    final $s50 = State('b');
    final $r60 = $r50($s50) as dynamic;
    expect($r60, isNull, reason: '@while (2) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s50.farthestPosition, 0, reason: '@while (2) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s50.position, 0, reason: '@while (2) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e12 = $s50.getErrors().map((e) => '$e').toList()..sort();
    expect($e12.length, 1, reason: '@while (2) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e12, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $s51 = State('b');
    final $r61 = $r51($s51) as dynamic;
    expect($r61, isNull, reason: '@while (2) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s51.farthestPosition, 0, reason: '@while (2) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s51.position, 0, reason: '@while (2) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e13 = $s51.getErrors().map((e) => '$e').toList()..sort();
    expect($e13.length, 1, reason: '@while (2) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e13, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $r62 = parser.parseWhile5;
    final $r63 = parser.parseWhileVoid5;
    final $s52 = State('aa');
    final $r64 = $r62($s52) as dynamic;
    expect($r64, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'aa\'\nresult != null\n');
    expect($s52.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r64.$1, [97, 97], reason: '@while (2) {\n  [a] / [z]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s53 = State('aa');
    final $r65 = $r63($s53) as dynamic;
    expect($r65, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'aa\'\nresult != null\n');
    expect($s53.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r65.$1, null, reason: '@while (2) {\n  [a] / [z]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s54 = State('az');
    final $r66 = $r62($s54) as dynamic;
    expect($r66, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'az\'\nresult != null\n');
    expect($s54.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'az\'\nstate.position = 2\n');
    expect($r66.$1, [97, 122], reason: '@while (2) {\n  [a] / [z]\n}\n\'az\'\nresult.\$1 != [97, 122]\n');
    final $s55 = State('az');
    final $r67 = $r63($s55) as dynamic;
    expect($r67, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'az\'\nresult != null\n');
    expect($s55.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'az\'\nstate.position = 2\n');
    expect($r67.$1, null, reason: '@while (2) {\n  [a] / [z]\n}\n\'az\'\nresult.\$1 != null\n');
    final $s56 = State('za');
    final $r68 = $r62($s56) as dynamic;
    expect($r68, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'za\'\nresult != null\n');
    expect($s56.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'za\'\nstate.position = 2\n');
    expect($r68.$1, [122, 97], reason: '@while (2) {\n  [a] / [z]\n}\n\'za\'\nresult.\$1 != [122, 97]\n');
    final $s57 = State('za');
    final $r69 = $r63($s57) as dynamic;
    expect($r69, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'za\'\nresult != null\n');
    expect($s57.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'za\'\nstate.position = 2\n');
    expect($r69.$1, null, reason: '@while (2) {\n  [a] / [z]\n}\n\'za\'\nresult.\$1 != null\n');
    final $s58 = State('zz');
    final $r70 = $r62($s58) as dynamic;
    expect($r70, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'zz\'\nresult != null\n');
    expect($s58.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'zz\'\nstate.position = 2\n');
    expect($r70.$1, [122, 122], reason: '@while (2) {\n  [a] / [z]\n}\n\'zz\'\nresult.\$1 != [122, 122]\n');
    final $s59 = State('zz');
    final $r71 = $r63($s59) as dynamic;
    expect($r71, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'zz\'\nresult != null\n');
    expect($s59.position, 2, reason: '@while (2) {\n  [a] / [z]\n}\n\'zz\'\nstate.position = 2\n');
    expect($r71.$1, null, reason: '@while (2) {\n  [a] / [z]\n}\n\'zz\'\nresult.\$1 != null\n');
    final $s60 = State('zzz');
    final $r72 = $r62($s60) as dynamic;
    expect($r72, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'zzz\'\nresult != null\n');
    expect($s60.position, 3, reason: '@while (2) {\n  [a] / [z]\n}\n\'zzz\'\nstate.position = 3\n');
    expect($r72.$1, [122, 122, 122], reason: '@while (2) {\n  [a] / [z]\n}\n\'zzz\'\nresult.\$1 != [122, 122, 122]\n');
    final $s61 = State('zzz');
    final $r73 = $r63($s61) as dynamic;
    expect($r73, isNotNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'zzz\'\nresult != null\n');
    expect($s61.position, 3, reason: '@while (2) {\n  [a] / [z]\n}\n\'zzz\'\nstate.position = 3\n');
    expect($r73.$1, null, reason: '@while (2) {\n  [a] / [z]\n}\n\'zzz\'\nresult.\$1 != null\n');
    final $s62 = State('');
    final $r74 = $r62($s62) as dynamic;
    expect($r74, isNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nresult == null\n');
    expect($s62.farthestPosition, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s62.position, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nstate.position = 0\n');
    final $e14 = $s62.getErrors().map((e) => '$e').toList()..sort();
    expect($e14.length, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nerror count\n');
    expect($e14, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nerrors\n');
    final $s63 = State('');
    final $r75 = $r63($s63) as dynamic;
    expect($r75, isNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nresult == null\n');
    expect($s63.farthestPosition, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s63.position, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nstate.position = 0\n');
    final $e15 = $s63.getErrors().map((e) => '$e').toList()..sort();
    expect($e15.length, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nerror count\n');
    expect($e15, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a] / [z]\n}\n\'\'\nerrors\n');
    final $s64 = State('a');
    final $r76 = $r62($s64) as dynamic;
    expect($r76, isNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nresult == null\n');
    expect($s64.farthestPosition, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s64.position, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nstate.position = 0\n');
    final $e16 = $s64.getErrors().map((e) => '$e').toList()..sort();
    expect($e16.length, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nerror count\n');
    expect($e16, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nerrors\n');
    final $s65 = State('a');
    final $r77 = $r63($s65) as dynamic;
    expect($r77, isNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nresult == null\n');
    expect($s65.farthestPosition, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s65.position, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nstate.position = 0\n');
    final $e17 = $s65.getErrors().map((e) => '$e').toList()..sort();
    expect($e17.length, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nerror count\n');
    expect($e17, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2) {\n  [a] / [z]\n}\n\'a\'\nerrors\n');
    final $s66 = State('b');
    final $r78 = $r62($s66) as dynamic;
    expect($r78, isNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nresult == null\n');
    expect($s66.farthestPosition, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s66.position, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nstate.position = 0\n');
    final $e18 = $s66.getErrors().map((e) => '$e').toList()..sort();
    expect($e18.length, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nerror count\n');
    expect($e18, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nerrors\n');
    final $s67 = State('b');
    final $r79 = $r63($s67) as dynamic;
    expect($r79, isNull, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nresult == null\n');
    expect($s67.farthestPosition, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s67.position, 0, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nstate.position = 0\n');
    final $e19 = $s67.getErrors().map((e) => '$e').toList()..sort();
    expect($e19.length, 1, reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nerror count\n');
    expect($e19, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2) {\n  [a] / [z]\n}\n\'b\'\nerrors\n');
    final $r80 = parser.parseWhile6;
    final $r81 = parser.parseWhileVoid6;
    final $s68 = State('a');
    final $r82 = $r80($s68) as dynamic;
    expect($r82, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s68.position, 1, reason: '@while (0, 1) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r82.$1, [97], reason: '@while (0, 1) {\n  [a]\n}\n\'a\'\nresult.\$1 != [97]\n');
    final $s69 = State('a');
    final $r83 = $r81($s69) as dynamic;
    expect($r83, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s69.position, 1, reason: '@while (0, 1) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r83.$1, null, reason: '@while (0, 1) {\n  [a]\n}\n\'a\'\nresult.\$1 != null\n');
    final $s70 = State('aa');
    final $r84 = $r80($s70) as dynamic;
    expect($r84, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s70.position, 1, reason: '@while (0, 1) {\n  [a]\n}\n\'aa\'\nstate.position = 1\n');
    expect($r84.$1, [97], reason: '@while (0, 1) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97]\n');
    final $s71 = State('aa');
    final $r85 = $r81($s71) as dynamic;
    expect($r85, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s71.position, 1, reason: '@while (0, 1) {\n  [a]\n}\n\'aa\'\nstate.position = 1\n');
    expect($r85.$1, null, reason: '@while (0, 1) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s72 = State('');
    final $r86 = $r80($s72) as dynamic;
    expect($r86, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'\'\nresult != null\n');
    expect($s72.position, 0, reason: '@while (0, 1) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    expect($r86.$1, <int>[], reason: '@while (0, 1) {\n  [a]\n}\n\'\'\nresult.\$1 != <int>[]\n');
    final $s73 = State('');
    final $r87 = $r81($s73) as dynamic;
    expect($r87, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'\'\nresult != null\n');
    expect($s73.position, 0, reason: '@while (0, 1) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    expect($r87.$1, null, reason: '@while (0, 1) {\n  [a]\n}\n\'\'\nresult.\$1 != null\n');
    final $s74 = State('b');
    final $r88 = $r80($s74) as dynamic;
    expect($r88, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'b\'\nresult != null\n');
    expect($s74.position, 0, reason: '@while (0, 1) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    expect($r88.$1, <int>[], reason: '@while (0, 1) {\n  [a]\n}\n\'b\'\nresult.\$1 != <int>[]\n');
    final $s75 = State('b');
    final $r89 = $r81($s75) as dynamic;
    expect($r89, isNotNull, reason: '@while (0, 1) {\n  [a]\n}\n\'b\'\nresult != null\n');
    expect($s75.position, 0, reason: '@while (0, 1) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    expect($r89.$1, null, reason: '@while (0, 1) {\n  [a]\n}\n\'b\'\nresult.\$1 != null\n');
    final $r90 = parser.parseWhile7;
    final $r91 = parser.parseWhileVoid7;
    final $s76 = State('a');
    final $r92 = $r90($s76) as dynamic;
    expect($r92, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s76.position, 1, reason: '@while (0, 2) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r92.$1, [97], reason: '@while (0, 2) {\n  [a]\n}\n\'a\'\nresult.\$1 != [97]\n');
    final $s77 = State('a');
    final $r93 = $r91($s77) as dynamic;
    expect($r93, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s77.position, 1, reason: '@while (0, 2) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r93.$1, null, reason: '@while (0, 2) {\n  [a]\n}\n\'a\'\nresult.\$1 != null\n');
    final $s78 = State('aa');
    final $r94 = $r90($s78) as dynamic;
    expect($r94, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s78.position, 2, reason: '@while (0, 2) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r94.$1, [97, 97], reason: '@while (0, 2) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s79 = State('aa');
    final $r95 = $r91($s79) as dynamic;
    expect($r95, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s79.position, 2, reason: '@while (0, 2) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r95.$1, null, reason: '@while (0, 2) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s80 = State('aaa');
    final $r96 = $r90($s80) as dynamic;
    expect($r96, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s80.position, 2, reason: '@while (0, 2) {\n  [a]\n}\n\'aaa\'\nstate.position = 2\n');
    expect($r96.$1, [97, 97], reason: '@while (0, 2) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != [97, 97]\n');
    final $s81 = State('aaa');
    final $r97 = $r91($s81) as dynamic;
    expect($r97, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s81.position, 2, reason: '@while (0, 2) {\n  [a]\n}\n\'aaa\'\nstate.position = 2\n');
    expect($r97.$1, null, reason: '@while (0, 2) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != null\n');
    final $s82 = State('');
    final $r98 = $r90($s82) as dynamic;
    expect($r98, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'\'\nresult != null\n');
    expect($s82.position, 0, reason: '@while (0, 2) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    expect($r98.$1, <int>[], reason: '@while (0, 2) {\n  [a]\n}\n\'\'\nresult.\$1 != <int>[]\n');
    final $s83 = State('');
    final $r99 = $r91($s83) as dynamic;
    expect($r99, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'\'\nresult != null\n');
    expect($s83.position, 0, reason: '@while (0, 2) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    expect($r99.$1, null, reason: '@while (0, 2) {\n  [a]\n}\n\'\'\nresult.\$1 != null\n');
    final $s84 = State('b');
    final $r100 = $r90($s84) as dynamic;
    expect($r100, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'b\'\nresult != null\n');
    expect($s84.position, 0, reason: '@while (0, 2) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    expect($r100.$1, <int>[], reason: '@while (0, 2) {\n  [a]\n}\n\'b\'\nresult.\$1 != <int>[]\n');
    final $s85 = State('b');
    final $r101 = $r91($s85) as dynamic;
    expect($r101, isNotNull, reason: '@while (0, 2) {\n  [a]\n}\n\'b\'\nresult != null\n');
    expect($s85.position, 0, reason: '@while (0, 2) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    expect($r101.$1, null, reason: '@while (0, 2) {\n  [a]\n}\n\'b\'\nresult.\$1 != null\n');
    final $r102 = parser.parseWhile8;
    final $r103 = parser.parseWhileVoid8;
    final $s86 = State('a');
    final $r104 = $r102($s86) as dynamic;
    expect($r104, isNotNull, reason: '@while (1, 1) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s86.position, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r104.$1, [97], reason: '@while (1, 1) {\n  [a]\n}\n\'a\'\nresult.\$1 != [97]\n');
    final $s87 = State('a');
    final $r105 = $r103($s87) as dynamic;
    expect($r105, isNotNull, reason: '@while (1, 1) {\n  [a]\n}\n\'a\'\nresult != null\n');
    expect($s87.position, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'a\'\nstate.position = 1\n');
    expect($r105.$1, null, reason: '@while (1, 1) {\n  [a]\n}\n\'a\'\nresult.\$1 != null\n');
    final $s88 = State('aa');
    final $r106 = $r102($s88) as dynamic;
    expect($r106, isNotNull, reason: '@while (1, 1) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s88.position, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'aa\'\nstate.position = 1\n');
    expect($r106.$1, [97], reason: '@while (1, 1) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97]\n');
    final $s89 = State('aa');
    final $r107 = $r103($s89) as dynamic;
    expect($r107, isNotNull, reason: '@while (1, 1) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s89.position, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'aa\'\nstate.position = 1\n');
    expect($r107.$1, null, reason: '@while (1, 1) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s90 = State('');
    final $r108 = $r102($s90) as dynamic;
    expect($r108, isNull, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s90.farthestPosition, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s90.position, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e20 = $s90.getErrors().map((e) => '$e').toList()..sort();
    expect($e20.length, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e20, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s91 = State('');
    final $r109 = $r103($s91) as dynamic;
    expect($r109, isNull, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s91.farthestPosition, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s91.position, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e21 = $s91.getErrors().map((e) => '$e').toList()..sort();
    expect($e21.length, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e21, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1, 1) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s92 = State('b');
    final $r110 = $r102($s92) as dynamic;
    expect($r110, isNull, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s92.farthestPosition, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s92.position, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e22 = $s92.getErrors().map((e) => '$e').toList()..sort();
    expect($e22.length, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e22, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $s93 = State('b');
    final $r111 = $r103($s93) as dynamic;
    expect($r111, isNull, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s93.farthestPosition, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s93.position, 0, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e23 = $s93.getErrors().map((e) => '$e').toList()..sort();
    expect($e23.length, 1, reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e23, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (1, 1) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $r112 = parser.parseWhile9;
    final $r113 = parser.parseWhileVoid9;
    final $s94 = State('aa');
    final $r114 = $r112($s94) as dynamic;
    expect($r114, isNotNull, reason: '@while (2, 2) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s94.position, 2, reason: '@while (2, 2) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r114.$1, [97, 97], reason: '@while (2, 2) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s95 = State('aa');
    final $r115 = $r113($s95) as dynamic;
    expect($r115, isNotNull, reason: '@while (2, 2) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s95.position, 2, reason: '@while (2, 2) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r115.$1, null, reason: '@while (2, 2) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s96 = State('aaa');
    final $r116 = $r112($s96) as dynamic;
    expect($r116, isNotNull, reason: '@while (2, 2) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s96.position, 2, reason: '@while (2, 2) {\n  [a]\n}\n\'aaa\'\nstate.position = 2\n');
    expect($r116.$1, [97, 97], reason: '@while (2, 2) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != [97, 97]\n');
    final $s97 = State('aaa');
    final $r117 = $r113($s97) as dynamic;
    expect($r117, isNotNull, reason: '@while (2, 2) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s97.position, 2, reason: '@while (2, 2) {\n  [a]\n}\n\'aaa\'\nstate.position = 2\n');
    expect($r117.$1, null, reason: '@while (2, 2) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != null\n');
    final $s98 = State('');
    final $r118 = $r112($s98) as dynamic;
    expect($r118, isNull, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s98.farthestPosition, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s98.position, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e24 = $s98.getErrors().map((e) => '$e').toList()..sort();
    expect($e24.length, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e24, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s99 = State('');
    final $r119 = $r113($s99) as dynamic;
    expect($r119, isNull, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s99.farthestPosition, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s99.position, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e25 = $s99.getErrors().map((e) => '$e').toList()..sort();
    expect($e25.length, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e25, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 2) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s100 = State('a');
    final $r120 = $r112($s100) as dynamic;
    expect($r120, isNull, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nresult == null\n');
    expect($s100.farthestPosition, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s100.position, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nstate.position = 0\n');
    final $e26 = $s100.getErrors().map((e) => '$e').toList()..sort();
    expect($e26.length, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nerror count\n');
    expect($e26, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nerrors\n');
    final $s101 = State('a');
    final $r121 = $r113($s101) as dynamic;
    expect($r121, isNull, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nresult == null\n');
    expect($s101.farthestPosition, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s101.position, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nstate.position = 0\n');
    final $e27 = $s101.getErrors().map((e) => '$e').toList()..sort();
    expect($e27.length, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nerror count\n');
    expect($e27, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2, 2) {\n  [a]\n}\n\'a\'\nerrors\n');
    final $s102 = State('b');
    final $r122 = $r112($s102) as dynamic;
    expect($r122, isNull, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s102.farthestPosition, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s102.position, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e28 = $s102.getErrors().map((e) => '$e').toList()..sort();
    expect($e28.length, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e28, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $s103 = State('b');
    final $r123 = $r113($s103) as dynamic;
    expect($r123, isNull, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s103.farthestPosition, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s103.position, 0, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e29 = $s103.getErrors().map((e) => '$e').toList()..sort();
    expect($e29.length, 1, reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e29, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 2) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $r124 = parser.parseWhile10;
    final $r125 = parser.parseWhileVoid10;
    final $s104 = State('aa');
    final $r126 = $r124($s104) as dynamic;
    expect($r126, isNotNull, reason: '@while (2, 3) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s104.position, 2, reason: '@while (2, 3) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r126.$1, [97, 97], reason: '@while (2, 3) {\n  [a]\n}\n\'aa\'\nresult.\$1 != [97, 97]\n');
    final $s105 = State('aa');
    final $r127 = $r125($s105) as dynamic;
    expect($r127, isNotNull, reason: '@while (2, 3) {\n  [a]\n}\n\'aa\'\nresult != null\n');
    expect($s105.position, 2, reason: '@while (2, 3) {\n  [a]\n}\n\'aa\'\nstate.position = 2\n');
    expect($r127.$1, null, reason: '@while (2, 3) {\n  [a]\n}\n\'aa\'\nresult.\$1 != null\n');
    final $s106 = State('aaa');
    final $r128 = $r124($s106) as dynamic;
    expect($r128, isNotNull, reason: '@while (2, 3) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s106.position, 3, reason: '@while (2, 3) {\n  [a]\n}\n\'aaa\'\nstate.position = 3\n');
    expect($r128.$1, [97, 97, 97], reason: '@while (2, 3) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != [97, 97, 97]\n');
    final $s107 = State('aaa');
    final $r129 = $r125($s107) as dynamic;
    expect($r129, isNotNull, reason: '@while (2, 3) {\n  [a]\n}\n\'aaa\'\nresult != null\n');
    expect($s107.position, 3, reason: '@while (2, 3) {\n  [a]\n}\n\'aaa\'\nstate.position = 3\n');
    expect($r129.$1, null, reason: '@while (2, 3) {\n  [a]\n}\n\'aaa\'\nresult.\$1 != null\n');
    final $s108 = State('aaaa');
    final $r130 = $r124($s108) as dynamic;
    expect($r130, isNotNull, reason: '@while (2, 3) {\n  [a]\n}\n\'aaaa\'\nresult != null\n');
    expect($s108.position, 3, reason: '@while (2, 3) {\n  [a]\n}\n\'aaaa\'\nstate.position = 3\n');
    expect($r130.$1, [97, 97, 97], reason: '@while (2, 3) {\n  [a]\n}\n\'aaaa\'\nresult.\$1 != [97, 97, 97]\n');
    final $s109 = State('aaaa');
    final $r131 = $r125($s109) as dynamic;
    expect($r131, isNotNull, reason: '@while (2, 3) {\n  [a]\n}\n\'aaaa\'\nresult != null\n');
    expect($s109.position, 3, reason: '@while (2, 3) {\n  [a]\n}\n\'aaaa\'\nstate.position = 3\n');
    expect($r131.$1, null, reason: '@while (2, 3) {\n  [a]\n}\n\'aaaa\'\nresult.\$1 != null\n');
    final $s110 = State('');
    final $r132 = $r124($s110) as dynamic;
    expect($r132, isNull, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s110.farthestPosition, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s110.position, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e30 = $s110.getErrors().map((e) => '$e').toList()..sort();
    expect($e30.length, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e30, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s111 = State('');
    final $r133 = $r125($s111) as dynamic;
    expect($r133, isNull, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nresult == null\n');
    expect($s111.farthestPosition, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s111.position, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nstate.position = 0\n');
    final $e31 = $s111.getErrors().map((e) => '$e').toList()..sort();
    expect($e31.length, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nerror count\n');
    expect($e31, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 3) {\n  [a]\n}\n\'\'\nerrors\n');
    final $s112 = State('a');
    final $r134 = $r124($s112) as dynamic;
    expect($r134, isNull, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nresult == null\n');
    expect($s112.farthestPosition, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s112.position, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nstate.position = 0\n');
    final $e32 = $s112.getErrors().map((e) => '$e').toList()..sort();
    expect($e32.length, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nerror count\n');
    expect($e32, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nerrors\n');
    final $s113 = State('a');
    final $r135 = $r125($s113) as dynamic;
    expect($r135, isNull, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nresult == null\n');
    expect($s113.farthestPosition, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s113.position, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nstate.position = 0\n');
    final $e33 = $s113.getErrors().map((e) => '$e').toList()..sort();
    expect($e33.length, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nerror count\n');
    expect($e33, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '@while (2, 3) {\n  [a]\n}\n\'a\'\nerrors\n');
    final $s114 = State('b');
    final $r136 = $r124($s114) as dynamic;
    expect($r136, isNull, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s114.farthestPosition, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s114.position, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e34 = $s114.getErrors().map((e) => '$e').toList()..sort();
    expect($e34.length, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e34, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $s115 = State('b');
    final $r137 = $r125($s115) as dynamic;
    expect($r137, isNull, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nresult == null\n');
    expect($s115.farthestPosition, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nstate.farthestPosition = 0\n');
    expect($s115.position, 0, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nstate.position = 0\n');
    final $e35 = $s115.getErrors().map((e) => '$e').toList()..sort();
    expect($e35.length, 1, reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nerror count\n');
    expect($e35, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '@while (2, 3) {\n  [a]\n}\n\'b\'\nerrors\n');
    final $r138 = parser.parseWhile11;
    final $r139 = parser.parseWhileVoid11;
    final $s116 = State('ac');
    final $r140 = $r138($s116) as dynamic;
    expect($r140, isNotNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'ac\'\nresult != null\n');
    expect($s116.position, 2, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'ac\'\nstate.position = 2\n');
    expect($r140.$1, [99], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'ac\'\nresult.\$1 != [99]\n');
    final $s117 = State('ac');
    final $r141 = $r139($s117) as dynamic;
    expect($r141, isNotNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'ac\'\nresult != null\n');
    expect($s117.position, 2, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'ac\'\nstate.position = 2\n');
    expect($r141.$1, null, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'ac\'\nresult.\$1 != null\n');
    final $s118 = State('bc');
    final $r142 = $r138($s118) as dynamic;
    expect($r142, isNotNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bc\'\nresult != null\n');
    expect($s118.position, 2, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bc\'\nstate.position = 2\n');
    expect($r142.$1, [99], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bc\'\nresult.\$1 != [99]\n');
    final $s119 = State('bc');
    final $r143 = $r139($s119) as dynamic;
    expect($r143, isNotNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bc\'\nresult != null\n');
    expect($s119.position, 2, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bc\'\nstate.position = 2\n');
    expect($r143.$1, null, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bc\'\nresult.\$1 != null\n');
    final $s120 = State('bcc');
    final $r144 = $r138($s120) as dynamic;
    expect($r144, isNotNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bcc\'\nresult != null\n');
    expect($s120.position, 3, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bcc\'\nstate.position = 3\n');
    expect($r144.$1, [99, 99], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bcc\'\nresult.\$1 != [99, 99]\n');
    final $s121 = State('bcc');
    final $r145 = $r139($s121) as dynamic;
    expect($r145, isNotNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bcc\'\nresult != null\n');
    expect($s121.position, 3, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bcc\'\nstate.position = 3\n');
    expect($r145.$1, null, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'bcc\'\nresult.\$1 != null\n');
    final $s122 = State('');
    final $r146 = $r138($s122) as dynamic;
    expect($r146, isNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nresult == null\n');
    expect($s122.farthestPosition, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s122.position, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nstate.position = 0\n');
    final $e36 = $s122.getErrors().map((e) => '$e').toList()..sort();
    expect($e36.length, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nerror count\n');
    expect($e36, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nerrors\n');
    final $s123 = State('');
    final $r147 = $r139($s123) as dynamic;
    expect($r147, isNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nresult == null\n');
    expect($s123.farthestPosition, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nstate.farthestPosition = 0\n');
    expect($s123.position, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nstate.position = 0\n');
    final $e37 = $s123.getErrors().map((e) => '$e').toList()..sort();
    expect($e37.length, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nerror count\n');
    expect($e37, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'\'\nerrors\n');
    final $s124 = State('a');
    final $r148 = $r138($s124) as dynamic;
    expect($r148, isNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nresult == null\n');
    expect($s124.farthestPosition, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s124.position, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nstate.position = 0\n');
    final $e38 = $s124.getErrors().map((e) => '$e').toList()..sort();
    expect($e38.length, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nerror count\n');
    expect($e38, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nerrors\n');
    final $s125 = State('a');
    final $r149 = $r139($s125) as dynamic;
    expect($r149, isNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nresult == null\n');
    expect($s125.farthestPosition, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nstate.farthestPosition = 1\n');
    expect($s125.position, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nstate.position = 0\n');
    final $e39 = $s125.getErrors().map((e) => '$e').toList()..sort();
    expect($e39.length, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nerror count\n');
    expect($e39, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'a\'\nerrors\n');
    final $s126 = State('b');
    final $r150 = $r138($s126) as dynamic;
    expect($r150, isNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nresult == null\n');
    expect($s126.farthestPosition, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nstate.farthestPosition = 1\n');
    expect($s126.position, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nstate.position = 0\n');
    final $e40 = $s126.getErrors().map((e) => '$e').toList()..sort();
    expect($e40.length, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nerror count\n');
    expect($e40, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nerrors\n');
    final $s127 = State('b');
    final $r151 = $r139($s127) as dynamic;
    expect($r151, isNull, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nresult == null\n');
    expect($s127.farthestPosition, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nstate.farthestPosition = 1\n');
    expect($s127.position, 0, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nstate.position = 0\n');
    final $e41 = $s127.getErrors().map((e) => '$e').toList()..sort();
    expect($e41.length, 1, reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nerror count\n');
    expect($e41, ['(end: 1, message: Unexpected input data, start: 1)'], reason: '([a] / [b])\n\$ = @while (1) {\n  [c]\n}\n\'b\'\nerrors\n');
  });
  ...
  test('Identifier', () {
    ...
    final $r2 = $r($s) as dynamic;
    expect($r2, isNotNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fo\'\nresult != null\n');
    expect($s.position, 2, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fo\'\nstate.position = 2\n');
    expect($r2.$1, 'fo', reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fo\'\nresult.\$1 != \'fo\'\n');
    final $s1 = State('fo');
    final $r3 = $r1($s1) as dynamic;
    expect($r3, isNotNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fo\'\nresult != null\n');
    expect($s1.position, 2, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fo\'\nstate.position = 2\n');
    expect($r3.$1, null, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fo\'\nresult.\$1 != null\n');
    final $s2 = State('fort');
    final $r4 = $r($s2) as dynamic;
    expect($r4, isNotNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fort\'\nresult != null\n');
    expect($s2.position, 4, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fort\'\nstate.position = 4\n');
    expect($r4.$1, 'fort', reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fort\'\nresult.\$1 != \'fort\'\n');
    final $s3 = State('fort');
    final $r5 = $r1($s3) as dynamic;
    expect($r5, isNotNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fort\'\nresult != null\n');
    expect($s3.position, 4, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fort\'\nstate.position = 4\n');
    expect($r5.$1, null, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'fort\'\nresult.\$1 != null\n');
    final $s4 = State('');
    final $r6 = $r($s4) as dynamic;
    expect($r6, isNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'\'\nresult == null\n');
    ...
    final $s6 = State('for');
    final $r8 = $r($s6) as dynamic;
    expect($r8, isNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nresult == null\n');
    expect($s6.farthestPosition, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nstate.farthestPosition = 0\n');
    expect($s6.position, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nstate.position = 0\n');
    final $e2 = $s6.getErrors().map((e) => '$e').toList()..sort();
    expect($e2.length, 1, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nerror count\n');
    expect($e2, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nerrors\n');
    final $s7 = State('for');
    final $r9 = $r1($s7) as dynamic;
    expect($r9, isNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nresult == null\n');
    expect($s7.farthestPosition, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nstate.farthestPosition = 0\n');
    expect($s7.position, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nstate.position = 0\n');
    final $e3 = $s7.getErrors().map((e) => '$e').toList()..sort();
    expect($e3.length, 1, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nerror count\n');
    expect($e3, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'for\'\nerrors\n');
    final $s8 = State('foreach');
    final $r10 = $r($s8) as dynamic;
    expect($r10, isNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nresult == null\n');
    expect($s8.farthestPosition, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nstate.farthestPosition = 0\n');
    expect($s8.position, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nstate.position = 0\n');
    final $e4 = $s8.getErrors().map((e) => '$e').toList()..sort();
    expect($e4.length, 1, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nerror count\n');
    expect($e4, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nerrors\n');
    final $s9 = State('foreach');
    final $r11 = $r1($s9) as dynamic;
    expect($r11, isNull, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nresult == null\n');
    expect($s9.farthestPosition, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nstate.farthestPosition = 0\n');
    expect($s9.position, 0, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nstate.position = 0\n');
    final $e5 = $s9.getErrors().map((e) => '$e').toList()..sort();
    expect($e5.length, 1, reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nerror count\n');
    expect($e5, ['(end: 0, message: Unexpected input data, start: 0)'], reason: '!(\n  (\n    "foreach"\n    ----\n    "for"\n  )\n  ! [a-zA-Z0-9]\n)\n\$ = <\n  [a-zA-Z]\n  [a-zA-Z0-9]*\n>\n\n\'foreach\'\nerrors\n');
  });
...
class _TestParser {
  ...
  /// ;
  /// ```
  Result<int> parseAction3(State state) {
    const x = 41;
    const $0 = x;
    return const Ok($0);
  }
  ...
  /// ;
  /// ```
  Result<void> parseActionVoid3(State state) {
    const x = 41;
    const $0 = x;
    return Result.none;
  }
