...
class _TestParser {
  ...
  Result<String>? parseIdentifier0(State state) {
    ...
    if ($res) {
      ...
      if ($ok1) {
        ...
        while (true) {
          final $c2 = state.ch;
          final $ok2 = $c2 <= 90 ? $c2 >= 65 || $c2 >= 48 && $c2 <= 57 : $c2 >= 97 && $c2 <= 122;
          // [a-zA-Z0-9]
          if ($ok2) {
            state.nextChar();
            continue;
  ...
  Result<String>? parseIdentifier1(State state) {
    ...
    if ($res1) {
      ...
      while (true) {
        final $c2 = state.ch;
        final $ok1 = $c2 <= 90 ? $c2 >= 65 || $c2 >= 48 && $c2 <= 57 : $c2 >= 97 && $c2 <= 122;
        // [a-zA-Z0-9]
        if ($ok1) {
          state.nextChar();
          end = state.position;
    ...
    if ($res) {
      ...
      if ($ok2) {
        ...
        if ($ok3) {
          ...
          while (true) {
            final $c3 = state.ch;
            final $ok4 = $c3 <= 90 ? $c3 >= 65 || $c3 >= 48 && $c3 <= 57 : $c3 >= 97 && $c3 <= 122;
            // [a-zA-Z0-9]
            if ($ok4) {
              state.nextChar();
              continue;
